...
public class htp1 extends javax.swing.JFrame {
    public htp1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(htp1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
